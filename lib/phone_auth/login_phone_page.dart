...
class _LoginPhonePageState extends State<LoginPhonePage> {
  ...
  void initFireBaseAuth() {
    ...
    firebaseAuth.setSettings(
        forceRecaptchaFlow: false, appVerificationDisabledForTesting: true);
  }
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    if (otpNum1.text.isNotEmpty &&
                      ...
                      var otp =
                          "${otpNum1.text.toString()}${otpNum2.text.toString()}${otpNum3.text.toString()}${otpNum4.text.toString()}${otpNum5.text.toString()}${otpNum6.text.toString()}";
                      print("otp: $otp");
